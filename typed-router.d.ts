...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'account-mfa-setup': RouteRecordInfo<'account-mfa-setup', '/account/mfa-setup', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-imara': RouteRecordInfo<'dashboards-imara', '/dashboards/imara', Record<never, never>, Record<never, never>>,
    ...
    'sales-billing-boq-id': RouteRecordInfo<'sales-billing-boq-id', '/sales-billing/boq/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'sales-billing-catalog': RouteRecordInfo<'sales-billing-catalog', '/sales-billing/catalog', Record<never, never>, Record<never, never>>,
    'sales-billing-leads': RouteRecordInfo<'sales-billing-leads', '/sales-billing/leads', Record<never, never>, Record<never, never>>,
    'sales-billing-parties': RouteRecordInfo<'sales-billing-parties', '/sales-billing/parties', Record<never, never>, Record<never, never>>,
    'sales-billing-quotations': RouteRecordInfo<'sales-billing-quotations', '/sales-billing/quotations', Record<never, never>, Record<never, never>>,
    'sales-billing-quotations-id': RouteRecordInfo<'sales-billing-quotations-id', '/sales-billing/quotations/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'sales-billing-quotations-create': RouteRecordInfo<'sales-billing-quotations-create', '/sales-billing/quotations/create', Record<never, never>, Record<never, never>>,
